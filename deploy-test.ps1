...
$ftpUrl = "ftp://$($config['FTP_HOST'])$($config['FTP_REMOTE_PATH'])/index-test.html"
Write-Host "Deploying public\index.html to $("ftp://$($config['FTP_HOST'])$($config['FTP_REMOTE_PATH'])/index-test.html") ..."
